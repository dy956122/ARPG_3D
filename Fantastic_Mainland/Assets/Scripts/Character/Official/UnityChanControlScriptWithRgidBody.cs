...
namespace UnityChan
{
    ...
    public class UnityChanControlScriptWithRgidBody : CharacterProperty
    {
        ...
        void Start()
        {
            ...
            orgColHight = selfCollider.height;
            orgVectColCenter = selfCollider.center;
            // Death += ()=> print("你GG了");
        }
            ...
            else if (currentBaseState.fullPathHash == jumpState)
            {
                ...
                if (!anim.IsInTransition(0))
                {
                    ...
                    if (useCurves)
                    {
                        ...
                        if (gravityControl > 0) rigid.useGravity = false;
                        ...
                        if (Physics.Raycast(ray, out hitInfo))
                        {
                            ...
                            {
                                selfCollider.height = orgColHight - jumpHeight;
                                float adjCenterY = orgVectColCenter.y + jumpHeight;
                                selfCollider.center = new Vector3(0, adjCenterY, 0);
                            }
                            else
                            {
                                resetCollider();
        ...
        void resetCollider()
        {
            selfCollider.height = orgColHight;
            selfCollider.center = orgVectColCenter;
        }
    }
}